...
namespace TwoCardPokerTests
{
    ...
    {
        [Fact]
        public void CompareTo_InputCardIsHigherValue_Returns1()
        {
        ...
        [Fact]
        public void CompareTo_InputCardIsLowerValue_ReturnsNeg1()
        {
        ...
        [Fact]
        public void CompareTo_InputCardIsLowerValueButHigherSuit_Returns1()
        {
            var losingCard = new Card(CardTypes.Suit.Hearts, CardTypes.Value.King);
